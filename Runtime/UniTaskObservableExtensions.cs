...
namespace UnityEssentials
{
    ...
    {
        public static Task<T> ToUniTask<T>(this IObservable<T> source, bool useFirstValue = false, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static IObservable<AsyncUnit> ToObservable(this Task task)
        {
            if (task.Status.IsCompleted())
            {
                try
