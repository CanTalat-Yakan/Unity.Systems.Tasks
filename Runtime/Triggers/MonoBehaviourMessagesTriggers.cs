...
#region FixedUpdate
    ...
    {
        Task FixedUpdateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncFixedUpdateHandler
    {
        Task IAsyncFixedUpdateHandler.FixedUpdateAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncFixedUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task FixedUpdateAsync()
        {
            return ((IAsyncFixedUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).FixedUpdateAsync();
        }

        public Task FixedUpdateAsync(CancellationToken cancellationToken)
        {
...
#region LateUpdate
    ...
    public sealed class AsyncLateUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task LateUpdateAsync()
        {
            return ((IAsyncLateUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).LateUpdateAsync();
        }

        public Task LateUpdateAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorIK
    ...
    {
        Task<int> OnAnimatorIKAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorIKHandler
    {
        Task<int> IAsyncOnAnimatorIKHandler.OnAnimatorIKAsync()
        {
            core.Reset();
            return new Task<int>((IUniTaskSource<int>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAnimatorIKTrigger : AsyncTriggerBase<int>
    {
        ...
        public Task<int> OnAnimatorIKAsync()
        {
            return ((IAsyncOnAnimatorIKHandler)new AsyncTriggerHandler<int>(this, true)).OnAnimatorIKAsync();
        }

        public Task<int> OnAnimatorIKAsync(CancellationToken cancellationToken)
        {
...
#region AnimatorMove
    ...
    {
        Task OnAnimatorMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorMoveHandler
    {
        Task IAsyncOnAnimatorMoveHandler.OnAnimatorMoveAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncAnimatorMoveTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnAnimatorMoveAsync()
        {
            return ((IAsyncOnAnimatorMoveHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnAnimatorMoveAsync();
        }

        public Task OnAnimatorMoveAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationFocus
    ...
    {
        Task<bool> OnApplicationFocusAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationFocusHandler
    {
        Task<bool> IAsyncOnApplicationFocusHandler.OnApplicationFocusAsync()
        {
            core.Reset();
            return new Task<bool>((IUniTaskSource<bool>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncApplicationFocusTrigger : AsyncTriggerBase<bool>
    {
        ...
        public Task<bool> OnApplicationFocusAsync()
        {
            return ((IAsyncOnApplicationFocusHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationFocusAsync();
        }

        public Task<bool> OnApplicationFocusAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationPause
    ...
    {
        Task<bool> OnApplicationPauseAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationPauseHandler
    {
        Task<bool> IAsyncOnApplicationPauseHandler.OnApplicationPauseAsync()
        {
            core.Reset();
            return new Task<bool>((IUniTaskSource<bool>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationPauseTrigger : AsyncTriggerBase<bool>
    {
        ...
        public Task<bool> OnApplicationPauseAsync()
        {
            return ((IAsyncOnApplicationPauseHandler)new AsyncTriggerHandler<bool>(this, true)).OnApplicationPauseAsync();
        }

        public Task<bool> OnApplicationPauseAsync(CancellationToken cancellationToken)
        {
...
#region ApplicationQuit
    ...
    {
        Task IAsyncOnApplicationQuitHandler.OnApplicationQuitAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationQuitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnApplicationQuitAsync()
        {
            return ((IAsyncOnApplicationQuitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnApplicationQuitAsync();
        }

        public Task OnApplicationQuitAsync(CancellationToken cancellationToken)
        {
...
#region AudioFilterRead
    ...
    {
        Task<(float[] data, int channels)> OnAudioFilterReadAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAudioFilterReadHandler
    {
        Task<(float[] data, int channels)> IAsyncOnAudioFilterReadHandler.OnAudioFilterReadAsync()
        {
            core.Reset();
            return new Task<(float[] data, int channels)>((IUniTaskSource<(float[] data, int channels)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAudioFilterReadTrigger : AsyncTriggerBase<(float[] data, int channels)>
    {
        ...
        public Task<(float[] data, int channels)> OnAudioFilterReadAsync()
        {
            return ((IAsyncOnAudioFilterReadHandler)new AsyncTriggerHandler<(float[] data, int channels)>(this, true)).OnAudioFilterReadAsync();
        }

        public Task<(float[] data, int channels)> OnAudioFilterReadAsync(CancellationToken cancellationToken)
        {
...
#region BecameInvisible
    ...
    {
        Task OnBecameInvisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameInvisibleHandler
    {
        Task IAsyncOnBecameInvisibleHandler.OnBecameInvisibleAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameInvisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnBecameInvisibleAsync()
        {
            return ((IAsyncOnBecameInvisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameInvisibleAsync();
        }

        public Task OnBecameInvisibleAsync(CancellationToken cancellationToken)
        {
...
#region BecameVisible
    ...
    {
        Task OnBecameVisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameVisibleHandler
    {
        Task IAsyncOnBecameVisibleHandler.OnBecameVisibleAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBecameVisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnBecameVisibleAsync()
        {
            return ((IAsyncOnBecameVisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnBecameVisibleAsync();
        }

        public Task OnBecameVisibleAsync(CancellationToken cancellationToken)
        {
...
#region BeforeTransformParentChanged
    ...
    {
        Task OnBeforeTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeforeTransformParentChangedHandler
    {
        Task IAsyncOnBeforeTransformParentChangedHandler.OnBeforeTransformParentChangedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncBeforeTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnBeforeTransformParentChangedAsync()
        {
        ...
        public Task OnBeforeTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region OnCanvasGroupChanged
    ...
    {
        Task OnCanvasGroupChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCanvasGroupChangedHandler
    {
        Task IAsyncOnCanvasGroupChangedHandler.OnCanvasGroupChangedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncOnCanvasGroupChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnCanvasGroupChangedAsync()
        {
            return ((IAsyncOnCanvasGroupChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnCanvasGroupChangedAsync();
        }

        public Task OnCanvasGroupChangedAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter
    ...
    {
        Task<Collision> OnCollisionEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnterHandler
    {
        Task<Collision> IAsyncOnCollisionEnterHandler.OnCollisionEnterAsync()
        {
            core.Reset();
            return new Task<Collision>((IUniTaskSource<Collision>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnterTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Task<Collision> OnCollisionEnterAsync()
        {
            return ((IAsyncOnCollisionEnterHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionEnterAsync();
        }

        public Task<Collision> OnCollisionEnterAsync(CancellationToken cancellationToken)
        {
...
#region CollisionEnter2D
    ...
    {
        Task<Collision2D> OnCollisionEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnter2DHandler
    {
        Task<Collision2D> IAsyncOnCollisionEnter2DHandler.OnCollisionEnter2DAsync()
        {
            core.Reset();
            return new Task<Collision2D>((IUniTaskSource<Collision2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnter2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Task<Collision2D> OnCollisionEnter2DAsync()
        {
            return ((IAsyncOnCollisionEnter2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionEnter2DAsync();
        }

        public Task<Collision2D> OnCollisionEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit
    ...
    {
        Task<Collision> OnCollisionExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExitHandler
    {
        Task<Collision> IAsyncOnCollisionExitHandler.OnCollisionExitAsync()
        {
            core.Reset();
            return new Task<Collision>((IUniTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExitTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Task<Collision> OnCollisionExitAsync()
        {
            return ((IAsyncOnCollisionExitHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionExitAsync();
        }

        public Task<Collision> OnCollisionExitAsync(CancellationToken cancellationToken)
        {
...
#region CollisionExit2D
    ...
    {
        Task<Collision2D> OnCollisionExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExit2DHandler
    {
        Task<Collision2D> IAsyncOnCollisionExit2DHandler.OnCollisionExit2DAsync()
        {
            core.Reset();
            return new Task<Collision2D>((IUniTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExit2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Task<Collision2D> OnCollisionExit2DAsync()
        {
            return ((IAsyncOnCollisionExit2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionExit2DAsync();
        }

        public Task<Collision2D> OnCollisionExit2DAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay
    ...
    {
        Task<Collision> OnCollisionStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStayHandler
    {
        Task<Collision> IAsyncOnCollisionStayHandler.OnCollisionStayAsync()
        {
            core.Reset();
            return new Task<Collision>((IUniTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStayTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public Task<Collision> OnCollisionStayAsync()
        {
            return ((IAsyncOnCollisionStayHandler)new AsyncTriggerHandler<Collision>(this, true)).OnCollisionStayAsync();
        }

        public Task<Collision> OnCollisionStayAsync(CancellationToken cancellationToken)
        {
...
#region CollisionStay2D
    ...
    {
        Task<Collision2D> OnCollisionStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStay2DHandler
    {
        Task<Collision2D> IAsyncOnCollisionStay2DHandler.OnCollisionStay2DAsync()
        {
            core.Reset();
            return new Task<Collision2D>((IUniTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStay2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public Task<Collision2D> OnCollisionStay2DAsync()
        {
            return ((IAsyncOnCollisionStay2DHandler)new AsyncTriggerHandler<Collision2D>(this, true)).OnCollisionStay2DAsync();
        }

        public Task<Collision2D> OnCollisionStay2DAsync(CancellationToken cancellationToken)
        {
...
#region ControllerColliderHit
    ...
    {
        Task<ControllerColliderHit> OnControllerColliderHitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnControllerColliderHitHandler
    {
        Task<ControllerColliderHit> IAsyncOnControllerColliderHitHandler.OnControllerColliderHitAsync()
        {
            core.Reset();
            return new Task<ControllerColliderHit>((IUniTaskSource<ControllerColliderHit>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncControllerColliderHitTrigger : AsyncTriggerBase<ControllerColliderHit>
    {
        ...
        public Task<ControllerColliderHit> OnControllerColliderHitAsync()
        {
        ...
        public Task<ControllerColliderHit> OnControllerColliderHitAsync(CancellationToken cancellationToken)
        {
...
#region Disable
    ...
    {
        Task IAsyncOnDisableHandler.OnDisableAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDisableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnDisableAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmos
    ...
    {
        Task OnDrawGizmosAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosHandler
    {
        Task IAsyncOnDrawGizmosHandler.OnDrawGizmosAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnDrawGizmosAsync()
        {
            return ((IAsyncOnDrawGizmosHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosAsync();
        }

        public Task OnDrawGizmosAsync(CancellationToken cancellationToken)
        {
...
#region DrawGizmosSelected
    ...
    {
        Task OnDrawGizmosSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosSelectedHandler
    {
        Task IAsyncOnDrawGizmosSelectedHandler.OnDrawGizmosSelectedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosSelectedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnDrawGizmosSelectedAsync()
        {
            return ((IAsyncOnDrawGizmosSelectedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDrawGizmosSelectedAsync();
        }

        public Task OnDrawGizmosSelectedAsync(CancellationToken cancellationToken)
        {
...
#region Enable
    ...
    {
        Task IAsyncOnEnableHandler.OnEnableAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncEnableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnEnableAsync(CancellationToken cancellationToken)
        {
...
#region GUI
    ...
    {
        Task IAsyncOnGUIHandler.OnGUIAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncGUITrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnGUIAsync()
        {
            return ((IAsyncOnGUIHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnGUIAsync();
        }

        public Task OnGUIAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak
    ...
    {
        Task<float> OnJointBreakAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreakHandler
    {
        Task<float> IAsyncOnJointBreakHandler.OnJointBreakAsync()
        {
            core.Reset();
            return new Task<float>((IUniTaskSource<float>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreakTrigger : AsyncTriggerBase<float>
    {
        ...
        public Task<float> OnJointBreakAsync()
        {
            return ((IAsyncOnJointBreakHandler)new AsyncTriggerHandler<float>(this, true)).OnJointBreakAsync();
        }

        public Task<float> OnJointBreakAsync(CancellationToken cancellationToken)
        {
...
#region JointBreak2D
    ...
    {
        Task<Joint2D> OnJointBreak2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreak2DHandler
    {
        Task<Joint2D> IAsyncOnJointBreak2DHandler.OnJointBreak2DAsync()
        {
            core.Reset();
            return new Task<Joint2D>((IUniTaskSource<Joint2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreak2DTrigger : AsyncTriggerBase<Joint2D>
    {
        ...
        public Task<Joint2D> OnJointBreak2DAsync()
        {
            return ((IAsyncOnJointBreak2DHandler)new AsyncTriggerHandler<Joint2D>(this, true)).OnJointBreak2DAsync();
        }

        public Task<Joint2D> OnJointBreak2DAsync(CancellationToken cancellationToken)
        {
...
#region MouseDown
    ...
    {
        Task OnMouseDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDownHandler
    {
        Task IAsyncOnMouseDownHandler.OnMouseDownAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDownTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseDownAsync()
        {
            return ((IAsyncOnMouseDownHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDownAsync();
        }

        public Task OnMouseDownAsync(CancellationToken cancellationToken)
        {
...
#region MouseDrag
    ...
    {
        Task OnMouseDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDragHandler
    {
        Task IAsyncOnMouseDragHandler.OnMouseDragAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDragTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseDragAsync()
        {
            return ((IAsyncOnMouseDragHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseDragAsync();
        }

        public Task OnMouseDragAsync(CancellationToken cancellationToken)
        {
...
#region MouseEnter
    ...
    {
        Task OnMouseEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseEnterHandler
    {
        Task IAsyncOnMouseEnterHandler.OnMouseEnterAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseEnterTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseEnterAsync()
        {
            return ((IAsyncOnMouseEnterHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseEnterAsync();
        }

        public Task OnMouseEnterAsync(CancellationToken cancellationToken)
        {
...
#region MouseExit
    ...
    {
        Task OnMouseExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseExitHandler
    {
        Task IAsyncOnMouseExitHandler.OnMouseExitAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseExitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseExitAsync()
        {
            return ((IAsyncOnMouseExitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseExitAsync();
        }

        public Task OnMouseExitAsync(CancellationToken cancellationToken)
        {
...
#region MouseOver
    ...
    {
        Task OnMouseOverAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseOverHandler
    {
        Task IAsyncOnMouseOverHandler.OnMouseOverAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseOverTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseOverAsync()
        {
            return ((IAsyncOnMouseOverHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseOverAsync();
        }

        public Task OnMouseOverAsync(CancellationToken cancellationToken)
        {
...
#region MouseUp
    ...
    {
        Task IAsyncOnMouseUpHandler.OnMouseUpAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseUpAsync()
        {
            return ((IAsyncOnMouseUpHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsync();
        }

        public Task OnMouseUpAsync(CancellationToken cancellationToken)
        {
...
#region MouseUpAsButton
    ...
    {
        Task OnMouseUpAsButtonAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseUpAsButtonHandler
    {
        Task IAsyncOnMouseUpAsButtonHandler.OnMouseUpAsButtonAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpAsButtonTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnMouseUpAsButtonAsync()
        {
            return ((IAsyncOnMouseUpAsButtonHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsButtonAsync();
        }

        public Task OnMouseUpAsButtonAsync(CancellationToken cancellationToken)
        {
...
#region ParticleCollision
    ...
    {
        Task<GameObject> OnParticleCollisionAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleCollisionHandler
    {
        Task<GameObject> IAsyncOnParticleCollisionHandler.OnParticleCollisionAsync()
        {
            core.Reset();
            return new Task<GameObject>((IUniTaskSource<GameObject>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleCollisionTrigger : AsyncTriggerBase<GameObject>
    {
        ...
        public Task<GameObject> OnParticleCollisionAsync()
        {
            return ((IAsyncOnParticleCollisionHandler)new AsyncTriggerHandler<GameObject>(this, true)).OnParticleCollisionAsync();
        }

        public Task<GameObject> OnParticleCollisionAsync(CancellationToken cancellationToken)
        {
...
#region ParticleSystemStopped
    ...
    {
        Task OnParticleSystemStoppedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleSystemStoppedHandler
    {
        Task IAsyncOnParticleSystemStoppedHandler.OnParticleSystemStoppedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleSystemStoppedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnParticleSystemStoppedAsync()
        {
            return ((IAsyncOnParticleSystemStoppedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleSystemStoppedAsync();
        }

        public Task OnParticleSystemStoppedAsync(CancellationToken cancellationToken)
        {
...
#region ParticleTrigger
    ...
    {
        Task OnParticleTriggerAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleTriggerHandler
    {
        Task IAsyncOnParticleTriggerHandler.OnParticleTriggerAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncParticleTriggerTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnParticleTriggerAsync()
        {
            return ((IAsyncOnParticleTriggerHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnParticleTriggerAsync();
        }

        public Task OnParticleTriggerAsync(CancellationToken cancellationToken)
        {
...
#region ParticleUpdateJobScheduled
    ...
    {
        Task<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleUpdateJobScheduledHandler
    {
        Task<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> IAsyncOnParticleUpdateJobScheduledHandler.OnParticleUpdateJobScheduledAsync()
        {
            core.Reset();
            return new Task<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>((IUniTaskSource<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncParticleUpdateJobScheduledTrigger : AsyncTriggerBase<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
    {
        ...
        public Task<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync()
        {
        ...
        public Task<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync(CancellationToken cancellationToken)
        {
...
#region PostRender
    ...
    {
        Task OnPostRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPostRenderHandler
    {
        Task IAsyncOnPostRenderHandler.OnPostRenderAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPostRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnPostRenderAsync()
        {
            return ((IAsyncOnPostRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPostRenderAsync();
        }

        public Task OnPostRenderAsync(CancellationToken cancellationToken)
        {
...
#region PreCull
    ...
    {
        Task IAsyncOnPreCullHandler.OnPreCullAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreCullTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnPreCullAsync()
        {
            return ((IAsyncOnPreCullHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreCullAsync();
        }

        public Task OnPreCullAsync(CancellationToken cancellationToken)
        {
...
#region PreRender
    ...
    {
        Task OnPreRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPreRenderHandler
    {
        Task IAsyncOnPreRenderHandler.OnPreRenderAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPreRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnPreRenderAsync()
        {
            return ((IAsyncOnPreRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreRenderAsync();
        }

        public Task OnPreRenderAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformDimensionsChange
    ...
    {
        Task OnRectTransformDimensionsChangeAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformDimensionsChangeHandler
    {
        Task IAsyncOnRectTransformDimensionsChangeHandler.OnRectTransformDimensionsChangeAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformDimensionsChangeTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnRectTransformDimensionsChangeAsync()
        {
        ...
        public Task OnRectTransformDimensionsChangeAsync(CancellationToken cancellationToken)
        {
...
#region RectTransformRemoved
    ...
    {
        Task OnRectTransformRemovedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformRemovedHandler
    {
        Task IAsyncOnRectTransformRemovedHandler.OnRectTransformRemovedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformRemovedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnRectTransformRemovedAsync()
        {
            return ((IAsyncOnRectTransformRemovedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRectTransformRemovedAsync();
        }

        public Task OnRectTransformRemovedAsync(CancellationToken cancellationToken)
        {
...
#region RenderImage
    ...
    {
        Task<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderImageHandler
    {
        Task<(RenderTexture source, RenderTexture destination)> IAsyncOnRenderImageHandler.OnRenderImageAsync()
        {
            core.Reset();
            return new Task<(RenderTexture source, RenderTexture destination)>((IUniTaskSource<(RenderTexture source, RenderTexture destination)>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncRenderImageTrigger : AsyncTriggerBase<(RenderTexture source, RenderTexture destination)>
    {
        ...
        public Task<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync()
        {
        ...
        public Task<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync(CancellationToken cancellationToken)
        {
...
#region RenderObject
    ...
    {
        Task OnRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderObjectHandler
    {
        Task IAsyncOnRenderObjectHandler.OnRenderObjectAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnRenderObjectAsync()
        {
            return ((IAsyncOnRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnRenderObjectAsync();
        }

        public Task OnRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region ServerInitialized
    ...
    {
        Task IAsyncOnServerInitializedHandler.OnServerInitializedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncServerInitializedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnServerInitializedAsync(CancellationToken cancellationToken)
        {
...
#region TransformChildrenChanged
    ...
    {
        Task OnTransformChildrenChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformChildrenChangedHandler
    {
        Task IAsyncOnTransformChildrenChangedHandler.OnTransformChildrenChangedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformChildrenChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnTransformChildrenChangedAsync()
        {
        ...
        public Task OnTransformChildrenChangedAsync(CancellationToken cancellationToken)
        {
...
#region TransformParentChanged
    ...
    {
        Task OnTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformParentChangedHandler
    {
        Task IAsyncOnTransformParentChangedHandler.OnTransformParentChangedAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnTransformParentChangedAsync()
        {
            return ((IAsyncOnTransformParentChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnTransformParentChangedAsync();
        }

        public Task OnTransformParentChangedAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter
    ...
    {
        Task<Collider> OnTriggerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnterHandler
    {
        Task<Collider> IAsyncOnTriggerEnterHandler.OnTriggerEnterAsync()
        {
            core.Reset();
            return new Task<Collider>((IUniTaskSource<Collider>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnterTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Task<Collider> OnTriggerEnterAsync()
        {
            return ((IAsyncOnTriggerEnterHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerEnterAsync();
        }

        public Task<Collider> OnTriggerEnterAsync(CancellationToken cancellationToken)
        {
...
#region TriggerEnter2D
    ...
    {
        Task<Collider2D> OnTriggerEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnter2DHandler
    {
        Task<Collider2D> IAsyncOnTriggerEnter2DHandler.OnTriggerEnter2DAsync()
        {
            core.Reset();
            return new Task<Collider2D>((IUniTaskSource<Collider2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnter2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Task<Collider2D> OnTriggerEnter2DAsync()
        {
            return ((IAsyncOnTriggerEnter2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerEnter2DAsync();
        }

        public Task<Collider2D> OnTriggerEnter2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit
    ...
    {
        Task<Collider> OnTriggerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExitHandler
    {
        Task<Collider> IAsyncOnTriggerExitHandler.OnTriggerExitAsync()
        {
            core.Reset();
            return new Task<Collider>((IUniTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExitTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Task<Collider> OnTriggerExitAsync()
        {
            return ((IAsyncOnTriggerExitHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerExitAsync();
        }

        public Task<Collider> OnTriggerExitAsync(CancellationToken cancellationToken)
        {
...
#region TriggerExit2D
    ...
    {
        Task<Collider2D> OnTriggerExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExit2DHandler
    {
        Task<Collider2D> IAsyncOnTriggerExit2DHandler.OnTriggerExit2DAsync()
        {
            core.Reset();
            return new Task<Collider2D>((IUniTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExit2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Task<Collider2D> OnTriggerExit2DAsync()
        {
            return ((IAsyncOnTriggerExit2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerExit2DAsync();
        }

        public Task<Collider2D> OnTriggerExit2DAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay
    ...
    {
        Task<Collider> OnTriggerStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStayHandler
    {
        Task<Collider> IAsyncOnTriggerStayHandler.OnTriggerStayAsync()
        {
            core.Reset();
            return new Task<Collider>((IUniTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStayTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public Task<Collider> OnTriggerStayAsync()
        {
            return ((IAsyncOnTriggerStayHandler)new AsyncTriggerHandler<Collider>(this, true)).OnTriggerStayAsync();
        }

        public Task<Collider> OnTriggerStayAsync(CancellationToken cancellationToken)
        {
...
#region TriggerStay2D
    ...
    {
        Task<Collider2D> OnTriggerStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStay2DHandler
    {
        Task<Collider2D> IAsyncOnTriggerStay2DHandler.OnTriggerStay2DAsync()
        {
            core.Reset();
            return new Task<Collider2D>((IUniTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStay2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public Task<Collider2D> OnTriggerStay2DAsync()
        {
            return ((IAsyncOnTriggerStay2DHandler)new AsyncTriggerHandler<Collider2D>(this, true)).OnTriggerStay2DAsync();
        }

        public Task<Collider2D> OnTriggerStay2DAsync(CancellationToken cancellationToken)
        {
...
#region Validate
    ...
    public sealed class AsyncValidateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnValidateAsync()
        {
            return ((IAsyncOnValidateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnValidateAsync();
        }

        public Task OnValidateAsync(CancellationToken cancellationToken)
        {
...
#region WillRenderObject
    ...
    {
        Task OnWillRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnWillRenderObjectHandler
    {
        Task IAsyncOnWillRenderObjectHandler.OnWillRenderObjectAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
    ...
    public sealed class AsyncWillRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public Task OnWillRenderObjectAsync()
        {
            return ((IAsyncOnWillRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnWillRenderObjectAsync();
        }

        public Task OnWillRenderObjectAsync(CancellationToken cancellationToken)
        {
...
#region Reset
    ...
    {
        Task IAsyncResetHandler.ResetAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
...
#region Update
    ...
    {
        Task IAsyncUpdateHandler.UpdateAsync()
        {
            core.Reset();
            return new Task((IUniTaskSource)(object)this, core.Version);
        }
...
#region BeginDrag
    ...
    {
        Task<PointerEventData> OnBeginDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeginDragHandler
    {
        Task<PointerEventData> IAsyncOnBeginDragHandler.OnBeginDragAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncBeginDragTrigger : AsyncTriggerBase<PointerEventData>, IBeginDragHandler
    {
        ...
        public Task<PointerEventData> OnBeginDragAsync()
        {
            return ((IAsyncOnBeginDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnBeginDragAsync();
        }

        public Task<PointerEventData> OnBeginDragAsync(CancellationToken cancellationToken)
        {
...
#region Cancel
    ...
    {
        Task<BaseEventData> OnCancelAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCancelHandler
    {
        Task<BaseEventData> IAsyncOnCancelHandler.OnCancelAsync()
        {
            core.Reset();
            return new Task<BaseEventData>((IUniTaskSource<BaseEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCancelTrigger : AsyncTriggerBase<BaseEventData>, ICancelHandler
    {
        ...
        public Task<BaseEventData> OnCancelAsync()
        {
            return ((IAsyncOnCancelHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnCancelAsync();
        }

        public Task<BaseEventData> OnCancelAsync(CancellationToken cancellationToken)
        {
...
#region Deselect
    ...
    {
        Task<BaseEventData> OnDeselectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDeselectHandler
    {
        Task<BaseEventData> IAsyncOnDeselectHandler.OnDeselectAsync()
        {
            core.Reset();
            return new Task<BaseEventData>((IUniTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDeselectTrigger : AsyncTriggerBase<BaseEventData>, IDeselectHandler
    {
        ...
        public Task<BaseEventData> OnDeselectAsync()
        {
            return ((IAsyncOnDeselectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnDeselectAsync();
        }

        public Task<BaseEventData> OnDeselectAsync(CancellationToken cancellationToken)
        {
...
#region Drag
    ...
    {
        Task<PointerEventData> OnDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDragHandler
    {
        Task<PointerEventData> IAsyncOnDragHandler.OnDragAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDragTrigger : AsyncTriggerBase<PointerEventData>, IDragHandler
    {
        ...
        public Task<PointerEventData> OnDragAsync()
        {
            return ((IAsyncOnDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDragAsync();
        }

        public Task<PointerEventData> OnDragAsync(CancellationToken cancellationToken)
        {
...
#region Drop
    ...
    {
        Task<PointerEventData> OnDropAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDropHandler
    {
        Task<PointerEventData> IAsyncOnDropHandler.OnDropAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDropTrigger : AsyncTriggerBase<PointerEventData>, IDropHandler
    {
        ...
        public Task<PointerEventData> OnDropAsync()
        {
            return ((IAsyncOnDropHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDropAsync();
        }

        public Task<PointerEventData> OnDropAsync(CancellationToken cancellationToken)
        {
...
#region EndDrag
    ...
    {
        Task<PointerEventData> OnEndDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnEndDragHandler
    {
        Task<PointerEventData> IAsyncOnEndDragHandler.OnEndDragAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncEndDragTrigger : AsyncTriggerBase<PointerEventData>, IEndDragHandler
    {
        ...
        public Task<PointerEventData> OnEndDragAsync()
        {
            return ((IAsyncOnEndDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnEndDragAsync();
        }

        public Task<PointerEventData> OnEndDragAsync(CancellationToken cancellationToken)
        {
...
#region InitializePotentialDrag
    ...
    {
        Task<PointerEventData> OnInitializePotentialDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnInitializePotentialDragHandler
    {
        Task<PointerEventData> IAsyncOnInitializePotentialDragHandler.OnInitializePotentialDragAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncInitializePotentialDragTrigger : AsyncTriggerBase<PointerEventData>, IInitializePotentialDragHandler
    {
        ...
        public Task<PointerEventData> OnInitializePotentialDragAsync()
        {
        ...
        public Task<PointerEventData> OnInitializePotentialDragAsync(CancellationToken cancellationToken)
        {
...
#region Move
    ...
    {
        Task<AxisEventData> OnMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMoveHandler
    {
        Task<AxisEventData> IAsyncOnMoveHandler.OnMoveAsync()
        {
            core.Reset();
            return new Task<AxisEventData>((IUniTaskSource<AxisEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncMoveTrigger : AsyncTriggerBase<AxisEventData>, IMoveHandler
    {
        ...
        public Task<AxisEventData> OnMoveAsync()
        {
            return ((IAsyncOnMoveHandler)new AsyncTriggerHandler<AxisEventData>(this, true)).OnMoveAsync();
        }

        public Task<AxisEventData> OnMoveAsync(CancellationToken cancellationToken)
        {
...
#region PointerClick
    ...
    {
        Task<PointerEventData> OnPointerClickAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerClickHandler
    {
        Task<PointerEventData> IAsyncOnPointerClickHandler.OnPointerClickAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerClickTrigger : AsyncTriggerBase<PointerEventData>, IPointerClickHandler
    {
        ...
        public Task<PointerEventData> OnPointerClickAsync()
        {
            return ((IAsyncOnPointerClickHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerClickAsync();
        }

        public Task<PointerEventData> OnPointerClickAsync(CancellationToken cancellationToken)
        {
...
#region PointerDown
    ...
    {
        Task<PointerEventData> OnPointerDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerDownHandler
    {
        Task<PointerEventData> IAsyncOnPointerDownHandler.OnPointerDownAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerDownTrigger : AsyncTriggerBase<PointerEventData>, IPointerDownHandler
    {
        ...
        public Task<PointerEventData> OnPointerDownAsync()
        {
            return ((IAsyncOnPointerDownHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerDownAsync();
        }

        public Task<PointerEventData> OnPointerDownAsync(CancellationToken cancellationToken)
        {
...
#region PointerEnter
    ...
    {
        Task<PointerEventData> OnPointerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerEnterHandler
    {
        Task<PointerEventData> IAsyncOnPointerEnterHandler.OnPointerEnterAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerEnterTrigger : AsyncTriggerBase<PointerEventData>, IPointerEnterHandler
    {
        ...
        public Task<PointerEventData> OnPointerEnterAsync()
        {
            return ((IAsyncOnPointerEnterHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerEnterAsync();
        }

        public Task<PointerEventData> OnPointerEnterAsync(CancellationToken cancellationToken)
        {
...
#region PointerExit
    ...
    {
        Task<PointerEventData> OnPointerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerExitHandler
    {
        Task<PointerEventData> IAsyncOnPointerExitHandler.OnPointerExitAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerExitTrigger : AsyncTriggerBase<PointerEventData>, IPointerExitHandler
    {
        ...
        public Task<PointerEventData> OnPointerExitAsync()
        {
            return ((IAsyncOnPointerExitHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerExitAsync();
        }

        public Task<PointerEventData> OnPointerExitAsync(CancellationToken cancellationToken)
        {
...
#region PointerUp
    ...
    {
        Task<PointerEventData> OnPointerUpAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerUpHandler
    {
        Task<PointerEventData> IAsyncOnPointerUpHandler.OnPointerUpAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncPointerUpTrigger : AsyncTriggerBase<PointerEventData>, IPointerUpHandler
    {
        ...
        public Task<PointerEventData> OnPointerUpAsync()
        {
            return ((IAsyncOnPointerUpHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnPointerUpAsync();
        }

        public Task<PointerEventData> OnPointerUpAsync(CancellationToken cancellationToken)
        {
...
#region Scroll
    ...
    {
        Task<PointerEventData> OnScrollAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnScrollHandler
    {
        Task<PointerEventData> IAsyncOnScrollHandler.OnScrollAsync()
        {
            core.Reset();
            return new Task<PointerEventData>((IUniTaskSource<PointerEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncScrollTrigger : AsyncTriggerBase<PointerEventData>, IScrollHandler
    {
        ...
        public Task<PointerEventData> OnScrollAsync()
        {
            return ((IAsyncOnScrollHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnScrollAsync();
        }

        public Task<PointerEventData> OnScrollAsync(CancellationToken cancellationToken)
        {
...
#region Select
    ...
    {
        Task<BaseEventData> OnSelectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSelectHandler
    {
        Task<BaseEventData> IAsyncOnSelectHandler.OnSelectAsync()
        {
            core.Reset();
            return new Task<BaseEventData>((IUniTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSelectTrigger : AsyncTriggerBase<BaseEventData>, ISelectHandler
    {
        ...
        public Task<BaseEventData> OnSelectAsync()
        {
            return ((IAsyncOnSelectHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSelectAsync();
        }

        public Task<BaseEventData> OnSelectAsync(CancellationToken cancellationToken)
        {
...
#region Submit
    ...
    {
        Task<BaseEventData> OnSubmitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSubmitHandler
    {
        Task<BaseEventData> IAsyncOnSubmitHandler.OnSubmitAsync()
        {
            core.Reset();
            return new Task<BaseEventData>((IUniTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSubmitTrigger : AsyncTriggerBase<BaseEventData>, ISubmitHandler
    {
        ...
        public Task<BaseEventData> OnSubmitAsync()
        {
            return ((IAsyncOnSubmitHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnSubmitAsync();
        }

        public Task<BaseEventData> OnSubmitAsync(CancellationToken cancellationToken)
        {
...
#region UpdateSelected
    ...
    {
        Task<BaseEventData> OnUpdateSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnUpdateSelectedHandler
    {
        Task<BaseEventData> IAsyncOnUpdateSelectedHandler.OnUpdateSelectedAsync()
        {
            core.Reset();
            return new Task<BaseEventData>((IUniTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateSelectedTrigger : AsyncTriggerBase<BaseEventData>, IUpdateSelectedHandler
    {
        ...
        public Task<BaseEventData> OnUpdateSelectedAsync()
        {
            return ((IAsyncOnUpdateSelectedHandler)new AsyncTriggerHandler<BaseEventData>(this, true)).OnUpdateSelectedAsync();
        }

        public Task<BaseEventData> OnUpdateSelectedAsync(CancellationToken cancellationToken)
        {
