...
namespace UnityEssentials.Threading.Tasks
{
    public static partial class TextMeshProAsyncExtensions
    {
        ...
        public static Task<string> OnValueChangedAsync(this TMP_InputField inputField)
        {
        ...
        public static Task<string> OnValueChangedAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnEndEditAsync(this TMP_InputField inputField)
        {
        ...
        public static Task<string> OnEndEditAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<(string, int, int)> OnEndTextSelectionAsync(this TMP_InputField inputField)
        {
        ...
        public static Task<(string, int, int)> OnEndTextSelectionAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<(string, int, int)> OnTextSelectionAsync(this TMP_InputField inputField)
        {
        ...
        public static Task<(string, int, int)> OnTextSelectionAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnDeselectAsync(this TMP_InputField inputField)
        {
        ...
        public static Task<string> OnDeselectAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnSelectAsync(this TMP_InputField inputField)
        {
            return new AsyncUnityEventHandler<string>(inputField.onSelect, inputField.GetCancellationTokenOnDestroy(), true).OnInvokeAsync();
        }

        public static Task<string> OnSelectAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnSubmitAsync(this TMP_InputField inputField)
        {
            return new AsyncUnityEventHandler<string>(inputField.onSubmit, inputField.GetCancellationTokenOnDestroy(), true).OnInvokeAsync();
        }

        public static Task<string> OnSubmitAsync(this TMP_InputField inputField, CancellationToken cancellationToken)
        {
