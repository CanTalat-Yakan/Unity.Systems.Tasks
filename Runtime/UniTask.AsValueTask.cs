...
namespace UnityEssentials.Threading.Tasks
{
    ...
    {
        public static ValueTask AsValueTask(this in Task task)
        {
        ...
        public static ValueTask<T> AsValueTask<T>(this in Task<T> task)
        {
#if (UNITASK_NETCORE && NETSTANDARD2_0)
        ...
        public static async Task<T> AsUniTask<T>(this ValueTask<T> task)
        {
            return await task;
        }

        public static async Task AsUniTask(this ValueTask task)
        {
            await task;
        }
