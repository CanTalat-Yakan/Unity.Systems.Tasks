...
namespace UnityEssentials.Threading.Tasks
{
    public static partial class UnityAsyncExtensions
    {
        ...
        public static Task OnInvokeAsync(this UnityEvent unityEvent, CancellationToken cancellationToken)
        {
        ...
        public static Task<T> OnInvokeAsync<T>(this UnityEvent<T> unityEvent, CancellationToken cancellationToken)
        {
        ...
        public static Task OnClickAsync(this Button button)
        {
        ...
        public static Task<bool> OnValueChangedAsync(this Toggle toggle)
        {
            return new AsyncUnityEventHandler<bool>(toggle.onValueChanged, toggle.GetCancellationTokenOnDestroy(), true).OnInvokeAsync();
        }

        public static Task<bool> OnValueChangedAsync(this Toggle toggle, CancellationToken cancellationToken)
        {
        ...
        public static Task<float> OnValueChangedAsync(this Scrollbar scrollbar)
        {
        ...
        public static Task<float> OnValueChangedAsync(this Scrollbar scrollbar, CancellationToken cancellationToken)
        {
        ...
        public static Task<Vector2> OnValueChangedAsync(this ScrollRect scrollRect)
        {
        ...
        public static Task<Vector2> OnValueChangedAsync(this ScrollRect scrollRect, CancellationToken cancellationToken)
        {
        ...
        public static Task<float> OnValueChangedAsync(this Slider slider)
        {
            return new AsyncUnityEventHandler<float>(slider.onValueChanged, slider.GetCancellationTokenOnDestroy(), true).OnInvokeAsync();
        }

        public static Task<float> OnValueChangedAsync(this Slider slider, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnEndEditAsync(this InputField inputField)
        {
        ...
        public static Task<string> OnEndEditAsync(this InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<string> OnValueChangedAsync(this InputField inputField)
        {
        ...
        public static Task<string> OnValueChangedAsync(this InputField inputField, CancellationToken cancellationToken)
        {
        ...
        public static Task<int> OnValueChangedAsync(this Dropdown dropdown)
        {
            return new AsyncUnityEventHandler<int>(dropdown.onValueChanged, dropdown.GetCancellationTokenOnDestroy(), true).OnInvokeAsync();
        }

        public static Task<int> OnValueChangedAsync(this Dropdown dropdown, CancellationToken cancellationToken)
        {
    ...
    public class AsyncUnityEventHandler : IUniTaskSource, IDisposable, IAsyncClickEventHandler
    {
        ...
        Task IAsyncClickEventHandler.OnClickAsync()
        {
        ...
        , IAsyncEndTextSelectionEventHandler<T>, IAsyncTextSelectionEventHandler<T>, IAsyncDeselectEventHandler<T>, IAsyncSelectEventHandler<T>, IAsyncSubmitEventHandler<T>
    {
        ...
        public Task<T> OnInvokeAsync()
        {
            ...
            return new Task<T>(this, core.Version);
        }
        ...
        Task<T> IAsyncValueChangedEventHandler<T>.OnValueChangedAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncEndEditEventHandler<T>.OnEndEditAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncEndTextSelectionEventHandler<T>.OnEndTextSelectionAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncTextSelectionEventHandler<T>.OnTextSelectionAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncDeselectEventHandler<T>.OnDeselectAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncSelectEventHandler<T>.OnSelectAsync()
        {
            return OnInvokeAsync();
        }

        Task<T> IAsyncSubmitEventHandler<T>.OnSubmitAsync()
        {
            return OnInvokeAsync();
        }
