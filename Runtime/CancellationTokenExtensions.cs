...
namespace UnityEssentials
{
    public static class CancellationTokenExtensions
    {
        ...
        public static CancellationToken ToCancellationToken(this Task task, CancellationToken linkToken)
        {
        ...
        public static CancellationToken ToCancellationToken<T>(this Task<T> task)
        {
            return ToCancellationToken(task.AsUniTask());
        }

        public static CancellationToken ToCancellationToken<T>(this Task<T> task, CancellationToken linkToken)
        {
        ...
        public static (Task, CancellationTokenRegistration) ToUniTask(this CancellationToken cancellationToken)
        {
            if (cancellationToken.IsCancellationRequested)
            {
                return (Task.FromCanceled(cancellationToken), default(CancellationTokenRegistration));
            }
