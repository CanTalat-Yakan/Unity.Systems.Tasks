...
namespace UnityEssentials
{
    public static partial class UniTaskAsyncEnumerable
    {
        ...
        public static IUniTaskAsyncEnumerable<TSource> ToUniTaskAsyncEnumerable<TSource>(this System.Threading.Tasks.Task<TSource> source)
        {
            Error.ThrowArgumentNullException(source, nameof(source));
    ...
    {
        readonly System.Threading.Tasks.Task<T> source;

        public ToUniTaskAsyncEnumerableTask(System.Threading.Tasks.Task<T> source)
        {
            this.source = source;
        }
        ...
        class _ToUniTaskAsyncEnumerableTask : IUniTaskAsyncEnumerator<T>
        {
            ...
            public _ToUniTaskAsyncEnumerableTask(System.Threading.Tasks.Task<T> source, CancellationToken cancellationToken)
            {
                this.source = source;
                this.cancellationToken = cancellationToken;
    ...
    internal class ToUniTaskAsyncEnumerableUniTask<T> : IUniTaskAsyncEnumerable<T>
    {
        ...
        public ToUniTaskAsyncEnumerableUniTask(Task<T> source)
        {
            this.source = source;
        }
        ...
        class _ToUniTaskAsyncEnumerableUniTask : IUniTaskAsyncEnumerator<T>
        {
            ...
            public _ToUniTaskAsyncEnumerableUniTask(Task<T> source, CancellationToken cancellationToken)
            {
                this.source = source;
                this.cancellationToken = cancellationToken;
